...
1. Open the root shell by pressing 1 in mush or typing `shell` in crosh.
...
4. In the "Extension root directory" box, select the `goguardian-dump/EXTENSION-ID/VERSION/` folder. No need to select a private key file.
