---
title: "Installing Fakemurk"
---

![Replace All Button](/img/murkmod.png)
...
Users have reported that murkmod is buggy and may break your device. Proceed with caution.

:::

Now that you fakemurked your deivce, you can now install murkmod, which allows for plugins to be installed to a fakemurked device. Just continue to [Installing Murkmod](extras/murkmod)

Or, you can skip murkmod and continue to [Finalizing Setup](finalizing-setup) or if your school uses GoGuardian, you can go to [FakeGuardian](fakeguardian)
