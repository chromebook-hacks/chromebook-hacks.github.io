...
I highly recommend that you install murkmod, which allows for plugins to be installed to a fakemurked device. Just continue to [Installing Murkmod](murkmod)
