...
You will be prompted to opt-in to analytics. Murkmod does not contain analytics, so this will be a one-time operation. Fakemurk analytics are anonymous and I  reccomend you enable them.
...
It is  recommended that if your school uses GoGuardian that you use [FakeGuardian](fakeguardian).
